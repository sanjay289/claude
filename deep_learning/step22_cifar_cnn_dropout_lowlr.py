...
# step20's dropout architecture + step21's lower base learning rate, combined
model = nn.Sequential(
...
BASE_LR = 3e-4  # same lowered rate as step21
...
for epoch in range(N_EPOCHS):
    ...
    if test_acc > best_acc:
        ...
        torch.save(model.state_dict(), "best_cnn_cifar_dropout_lowlr.pt")
